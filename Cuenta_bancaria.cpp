...
int main(){
    ...
    cuenta_1.resumencuenta();
    std::cout<<"Prueva cuenta_2:"<<std::endl;
    cuenta_2.resumencuenta();
    std::cout<<'\n';
    ...
    IngresosMensuales cuenta_4(nom, ing, inter, dep);
    ...
    cuenta_4.resumen();
    std::cout<<"Prueba cuenta_3:"<<std::endl;
    cuenta_3.resumen();
    std::cout<<'\n';
    ...
    std::cout<<"Intereses:"<<cuenta_6.get_interes()<<std::endl;
    ...
    cuenta_6.set_anos(2);
    cuenta_6.ganancias();
    std::cout<<"Prueba cuenta_5:"<<std::endl;
    cuenta_5.ganancias();
